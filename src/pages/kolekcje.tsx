...
import SkeletonKolekcjePage from '../components/Product/SkeletonKolekcjePage'; // Import your custom skeleton loader
      ...
      <section className="w-full py-16 text-dark-pastel-red">
        <div className="container mx-auto max-w-grid-desktop">
          ...
          <div className="text-left mb-12">
            <h1 className="font-size-h1 font-bold text-dark-pastel-red">Kolekcje</h1>
          </div>
          <div className="grid grid-cols-2 gap-8 mb-12">
            <div>
              <p className="font-size-text-medium text-neutral-darkest">
                Zanurz się w piękno minimalistycznych linii, geometrycznych kształtów i eleganckich wykończeń, które łatwo dopełnią Twoje wnętrze. Poznaj uchwyty wykonane z najwyższej jakości materiałów, takich jak litły mosiądz, stal nierdzewna i aluminium.
              </p>
            </div>
            <div>
              <p className="font-size-text-medium text-neutral-darkest">
                Niezależnie od tego, czy wolisz eleganckie i nowoczesne projekty, czy eklektyczne i ozdobne style, nasze kolekcje oferują różnorodne opcje, które zaspokoją każdy gust i estetykę. 
                <Link href="#" className="text-dark-pastel-red font-bold"> Zobacz co ostatnio nowego dodaliśmy dla Ciebie.</Link>
              </p>
            </div>
          </div>
            ...
            <>
              ...
              <div className="grid grid-cols-4 gap-6">
                {kolekcjePosts.slice(3).map((kolekcja) => (
                  <div key={kolekcja.id} className="relative col-span-1 transition-all duration-300" style={{ height: '445px' }}>
                    <Link href={`/kolekcje/${kolekcja.slug}`}>
                        <Image
