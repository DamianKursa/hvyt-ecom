...
export const pl = {
    ...
    checkout: {
      ...
      shippingLocationPoland: 'Polska',  
      shippingLocationOther: 'Inny kraj',  
      personalData: {
        title: 'Dane osobowe',
      ...
      shipping: {
        ...
        selectCountryForShipping: 'Wybierz kraj, aby zobaczyć dostępne metody dostawy',
      ...
      payment: {
        ...
        noMethods: 'Wybierz sposób dostawy aby zobaczyć dostępne metody płatności.',
      ...
      validation: {
        ...
        city: 'Miasto',
        postalCode: 'Kod pocztowy',
        selectCountry: 'Kraj / Region',
      },
      deliveryAndPayment: 'Dostawa i płatność',
      delivery6weeks: 'Wysyłka w 6 tygodni',
      delivery24h: 'Wysyłka w 24h',
      deliveryInStock: 'Na stanie',
      deliveryOver50InStock: 'Ponad 50 szt. na stanie',
      deliveryOnlyXInStock: 'Tylko {count} szt. na stanie',
    ...
    auth: {
      ...
      activationSuccess: 'Konto zostało aktywowane. Możesz się zalogować.',
      activationInvalidToken: 'Link aktywacyjny jest nieprawidłowy lub został już użyty.',
      activationExpiredToken: 'Link aktywacyjny wygasł. Załóż konto ponownie lub poproś o nowy link.',
      activationAlreadyActive: 'To konto jest już aktywne. Możesz się zalogować.',
      activationMissingToken: 'Brak tokenu aktywacyjnego.',
      activationError: 'Nie udało się aktywować konta. Spróbuj ponownie później.',
