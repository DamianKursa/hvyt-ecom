...
export const en: Translations = {
  // === URL SLUGS ===
    ...
    checkout: {
      ...
      shippingLocationPoland: 'Poland',  
      shippingLocationOther: 'Other Country',           
      personalData: {
      ...
      shipping: {
        ...
        selectCountryForShipping: 'Select country to see available delivery methods',
      ...
      payment: {
        ...
        noMethods: 'Select delivery method to see available payment methods.',
      ...
      deliveryAndPayment: 'Delivery & Payment',
      delivery6weeks: 'Delivery in 6 weeks',
      delivery24h: 'Delivery in 24h',
      deliveryInStock: 'In stock',
      deliveryOver50InStock: 'Over 50 in stock',
      deliveryOnlyXInStock: 'Only {count} in stock',
  ...
  auth: {
    ...
    activationSuccess: 'Your account has been activated. You can log in now.',
    activationInvalidToken: 'The activation link is invalid or has already been used.',
    activationExpiredToken: 'The activation link has expired. Please register again or request a new link.',
    activationAlreadyActive: 'This account is already active. You can log in.',
    activationMissingToken: 'The activation token is missing.',
    activationError: 'Account activation failed. Please try again later.',
