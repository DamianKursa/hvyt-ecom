...
const ModalImageGallery: React.FC<ModalImageGalleryProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative bg-white rounded-lg shadow-lg mx-4 md:mx-0 md:px-0 flex items-center justify-center overflow-auto max-w-[80vw] max-h-[80vh] object-contain"
        style={
          {
