...
HVYT – nowi najlepsi przyjaciele Twojego domu.</p>`,
  ...
  "handles": [
    {
      ...
      "content": "<p>Has your cabinet handle broken and you want to replace it with a new one? Or maybe the old one just doesn't meet your expectations? No problem! HVYT cabinet handles come in shapes, colors, and sizes that philosophers never even dreamed of. The ones contemplating interior design, of course!</p>"
    },
    {
      "title": "Designer Cabinet handles",
      "content": "<p>Hey, hey! Are there any aesthetes out there? Our designer cabinet handles were created with you in mind. Each one corresponds to a different style, is meticulously crafted, and has a unique character. We've checked the meaning of the word 'designer' in the dictionary many times, and we are sure we rose to the challenge when creating them.</p>\n<p>A designer cabinet handle should have:</p>\n<ul>\n<li><strong>An interesting artistic form</strong>, see: <a href=\"/uchwyt-retro\">RETRO SZTUĆCE Handle</a></li>\n<li><strong>Interesting design</strong>, see: <a href=\"/uchwyt-tilos\">TILOS OLD GOLD Handle</a></li>\n<li><strong>Non-obvious solutions</strong>, see: <a href=\"/uchwyt-coco\">COCO GOLD EDGE Handle</a></li>\n</ul>\n<p>But it doesn't end there, because besides being designer, HVYT handles are stylish and modern. They work well in interiors with soul, where every element is thought out, but also where there is artistic disorder. By modern cabinet handles, we mean their original shapes and metallic luster. We see them in minimalist, glamour, and industrial interiors. Stylish cabinet handles, on the other hand, are those that have a characteristic finish corresponding to the aesthetic norms accepted in a given period or region. They will fit perfectly into retro, Provencal, and Scandinavian styles.</p>"
    },
    {
      "title": "Decorative Cabinet handles",
      "content": "<p>Imagine a situation where you are faced with choosing a cabinet handle. You're standing, although you're actually sitting comfortably on the couch, browsing our site. Your attention is drawn to the FRIDA EDGE Handle, because its form is not obvious, and the very idea of installing an edge handle seems innovative. We'll let you in on a secret: it's a solution as old as the hills, but we agree on one thing – this handle is exceptional. Decorative cabinet handles have the advantage over 'ordinary' ones in that they attract attention. Thanks to them, when you invite the family for the holidays, you will never again hear: 'Oh boy, you could at least paint these handles' or 'Honey, maybe I'll send you a transfer so you could buy yourself new handles.'</p>\n<p>Need a cabinet handle right away? Check out our offer and choose a product tailored to your interior. A set of filters will help you with this, allowing you to specify the style, material, color, and price range. Don't think too long and go <strong>for HVYT cabinet handles!</strong></p>\n<p>Also see <a href=\"\">door handles</a> in our offer.</p>"
    }
  ],
  "door-handles": [
      {
  ...
  <p>Also, check out our hooks in our offer.</p>`,
      },
    ],
'hooks': [
    {
      title: 'Hooks',
      content: `
        <p>A wall hook should be durable, useful, and beautifully designed, serving not only its intended function but also becoming a decoration for the home. HVYT hallway hooks are unique products that not only hold the clothing items hung on them perfectly but also look great. They are available in various sizes and shapes, making it easy to match them to a specific spot on the wall.</p>`,
    },
    {
      title: 'Hallway Hooks',
      content: `
        <p>The hallway. A room where we may not spend too much time, but we pass through it every day. This is where we hurriedly throw on a coat on colder days and take it off even faster when returning home after a hard day's work. In summer, we limit ourselves to just hanging keys on the hook or energetically removing a handbag from it in search of a wallet, which doesn't change the fact that hallway hooks experience a true armageddon with us. Several times a day they are unloaded and occupied, which is why it's so important to choose ones that won't get offended after a month. Broken elements and loosened mountings are a common problem that can be easily solved.</p>
<p>How to achieve this? By choosing modern HVYT hallway hooks. Most of our hooks are made from a zinc and aluminum alloy, which ensures their durability and unique shape. Zamak, as this material is commonly known, is characterized by extraordinary plasticity and, consequently, ease of processing. We utilize its properties in the production of our hooks, constantly devising newer forms that will fit perfectly into industrial, minimalist, and Scandinavian style interiors.</p>`,
    },
    {
      title: 'Metal Wall-Mounted Clothes Hooks',
      content: `
<p>However, the HVYT brand is not only about designer products straight out of Hollywood. In our offer, we also have more down-to-earth options, such as the MODERN Hook, which resembles classic hooks and is made 100% from metal. A metal wall-mounted clothes hook not only holds items hung on it excellently but also looks great while not being too conspicuous. It's a bit like a forgotten friend we can always count on.</p>
